  ...
  return (
    <main className="coverage-page">
      <header className="topbar coverage-nav">
        ...
        <div className="source-note"><Globe2 size={15} /> 全球政策数据库 · Phase 57</div>
      ...
      <footer><span>BorderLens Global Policy DB · Phase 57</span><span>来源可追溯 · 规则可过期 · 未验证不作答</span></footer>
    </main>
  );
}
