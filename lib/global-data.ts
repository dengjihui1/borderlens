...
export const latestPolicyBatch = [
  ...
  { id: 'ph', label: '菲律宾', note: '中国普通护照旅游/商务免签 14 天，但仅限马尼拉与宿务两个机场；港澳特区护照 9A 初始 14 天' },
  { id: 'vn', label: '越南', note: '中国、香港和澳门特区普通护照均可申请 Vietnam e-Visa，最长 90 天；保留指定口岸与 Chinese e-passport 边界' },
  { id: 'cr', label: '哥斯达黎加', note: '中国普通、香港特区和澳门特区普通护照均需领事签证；中国保留北京/上海签发护照的临时旅游例外' },
  { id: 'bo', label: '玻利维亚', note: '中国、香港、澳门特区普通护照列入 Tourist Visa Group II，需申请旅游签证' },
  { id: 'py', label: '巴拉圭', note: '中国、香港、澳门特区普通护照均需出发前签证' },
  { id: 'ec', label: '厄瓜多尔', note: '中国普通护照需预先签证；港澳特区护照官方参考表列 90 天免签或落地签，但产品仍待厄瓜多尔官方确认' },
  { id: 'ar', label: '阿根廷', note: '中国普通护照需签证；港澳特区护照表格未标需签证，停留期继续核验' },
  { id: 'cl', label: '智利', note: '中国普通护照有美/加签证条件免签；香港 90 天免签；澳门 30 天免签' },
  { id: 'co', label: '哥伦比亚', note: '中国普通护照有美国/申根条件免签；香港短期免签；澳门特区普通护照需 Visitor 签证' },
  { id: 'pe', label: '秘鲁', note: '中国普通护照有第三国签证例外；香港免签；澳门特区普通护照需旅游签证' },
  ...
  { id: 'om', label: '阿曼', note: '中国与香港返回 26A/26B 旅游签；澳门特区普通护照第一组免签最多 14 天' },
  { id: 'jo', label: '约旦', note: '中国、香港、澳门普通护照均可按官方表在抵达时办理签证，费用 40 JOD；停留期限待官方表进一步确认' },
...
/* PHASE_06_BATCH */
  ...
  { id: 'np', label: '尼泊尔', note: '中国普通及 HKSAR 护照需签证但免费，年度累计最多 150 天；澳门特区护照可进入官方落地签申请路线' },
  { id: 'bd', label: '孟加拉国', note: '中国普通护照可按官方条件申请最多 30 天落地签；香港和澳门特区普通护照需 Bangladesh Tourist Visa' },
